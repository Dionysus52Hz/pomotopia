...
function DialogPopup({
   ...
   return (
      <DialogPortalPrimitive>
         <DialogBackdrop className="backdrop-blur-[2px]" />
         ...
         >
            {children}
            {showCloseButton && (
               <DialogClosePrimitive className="absolute end-4 top-4 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none data-[open]:bg-accent data-[open]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4">
                  <XIcon />
